...
- **Supported Macs:** `andrews-mac-mini` (current Mac mini) and `qianas-macbook-pro` (remote MacBook Pro), connected through Tailscale and expected to run the same tracked dotfiles.
